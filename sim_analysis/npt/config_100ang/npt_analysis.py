...
# 0.3 GPa
analysis.npt_analysis(
    energy_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_pot03.xvg",
    temperature_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_temp03.xvg",
    pressure_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_pressure03.xvg",
...
# 0.4 GPa
analysis.npt_analysis(
    energy_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_pot04.xvg",
    temperature_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_temp04.xvg",
    pressure_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_pressure04.xvg",
...
# 0.5 GPa
analysis.npt_analysis(
    energy_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_pot05.xvg",
    temperature_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_temp05.xvg",
    pressure_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_100ang/npt_nap_pvp_pressure05.xvg",
