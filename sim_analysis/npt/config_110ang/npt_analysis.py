# NPT Simulation Analysis for the intial 110 angstrom simulation box
from modules import analysis

# 0.1 GPa
analysis.npt_analysis(
    energy_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_110ang/npt_nap_pvp_pot01.xvg",
    temperature_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_110ang/npt_nap_pvp_temp01.xvg",
    pressure_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_110ang/npt_nap_pvp_pressure01.xvg",
...
# 0.2 GPa
analysis.npt_analysis(
    energy_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_110ang/npt_nap_pvp_pot02.xvg",
    temperature_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_110ang/npt_nap_pvp_temp02.xvg",
    pressure_xvg="/storage/chem/phuqdw/breaking_bad/gromacs/npt_compression/config_110ang/npt_nap_pvp_pressure02.xvg",
