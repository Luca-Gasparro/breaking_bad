...
from .analysis import average_box_length
...
def plot_rdfs(
    ...
    # API–API
    ax1.plot(api_bin, api_rdf)
    ax1.set_title("API-API RDF")
    ax1.set_ylabel("g(r)")
    ax1.set_xlabel("r (Å)")
    ax1.grid(True, linestyle=":", linewidth=0.5)

    # Polymer–Polymer
    ax2.plot(poly_bin, poly_rdf)
    ax2.set_title("Polymer-Polymer RDF")
    ax2.set_ylabel("g(r)")
    ax2.set_xlabel("r (Å)")
    ax2.grid(True, linestyle=":", linewidth=0.5)

    # Polymer–API
    ax3.plot(cross_bin, cross_rdf)
    ax3.set_title("Polymer-API RDF")
    ax3.set_ylabel("g(r)")
    ax3.set_xlabel("r (Å)")
