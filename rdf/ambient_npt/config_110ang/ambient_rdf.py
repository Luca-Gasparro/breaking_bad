...
utility.api_simulation_extractor(
    ...
    api_information_filename="/storage/chem/phuqdw/breaking_bad/gromacs/npt_ambient/config_110ang/api_coms.npz",
)

api_bin, api_rdf = rdf.api_api_rdf(
    api_information_file="/storage/chem/phuqdw/breaking_bad/gromacs/npt_ambient/config_110ang/api_coms.npz",
    bin_width=0.5,
    instantaneous=True,
    start_time=5000,
)
...
poly_bin, poly_rdf = rdf.polymer_polymer_rdf(
    polymer_topology_file="/storage/chem/phuqdw/breaking_bad/gromacs/npt_ambient/config_110ang/ambient_npt_poly.tpr",
    polymer_trajectory_file="/storage/chem/phuqdw/breaking_bad/gromacs/npt_ambient/config_110ang/ambient_npt_poly_trim.xtc",
...
rdf.plot_rdfs(
    ...
    output_dir="/storage/chem/phuqdw/breaking_bad/rdf/ambient_npt/config_110ang",
)
